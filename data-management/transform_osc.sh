...
#	echo $sub_ID $sub_key
	...
	for the_run in $(ls $source_dir/*$sub_ID*/*/ |grep OSC_DiCo)
	do
...
#		echo $n_files
		...
		then
			...
			echo $sub_ID $sub_key $the_run r0$run_counter
		   	...
		   	echo dcm2niix -o ./data/sub-$sub_key/ses-movie/func -f sub-$sub_key"_task-osc_run-0"$run_counter"_bold" -z y $source_dir/*$sub_ID*/*/$the_run/*.DCM
