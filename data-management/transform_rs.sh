...
#	echo $sub_ID $sub_key
	...
	for the_run in $(ls $source_dir/*$sub_ID*/*/ |grep RS_DiCo)
	do
...
#		echo $n_files
		...
		then
			...
			echo $sub_ID $sub_key $the_run r0$run_counter
		   	...
		   	dcm2niix -o ./data/sub-$sub_key/ses-movie/func -f sub-$sub_key"_task-rest_bold" -z y $source_dir/*$sub_ID*/*/$the_run/*.DCM
